		...
		<div class="row">
			...
			<div class="col-sm-2" id="sidebar">
				<ul class="sidebar-menu">
					...
					<li><a href="javascript:"><i class="fa fa-clone"></i>管理员管理</a>
						<ul class="sidebar-submenu">
							<li><a href="javascript:" view="listAllAdm"
								onclick="opentab(this,true);"><i class="fa fa-square-o"></i>查看全部管理员信息</a></li>
							<li><a href="javascript:" view="addAdm"
								onclick="opentab(this,true);"><i class="fa fa-square-o"></i>添加管理员信息</a></li>
						</ul></li>
