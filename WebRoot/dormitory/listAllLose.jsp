...
<body class="bg-b">
	...
	<script type="text/javaScript">
		...
		function operateFormatter(value, row, index) {//赋予的参数
     	return [
        '<a class="btn active btn-info btn-sm" onclick="modify(\'' + row.dorm_lose_lno + '\')">更新</a>&nbsp;&nbsp;',
        '<a class="btn active btn-info btn-sm" onclick="del(\'' + row.dorm_lose_lno + '\')">删除</a>&nbsp;&nbsp;',
        '<a class="btn active btn-info btn-sm" onclick="handel(\'' + row.dorm_lose_lno + '\')">领取</a>&nbsp;&nbsp;',
   		].join('');
   		}
   		function modify(dorm_lose_lno) {
			window.location.href="/dorm/lose/modify.do?dorm_lose_lno="+dorm_lose_lno;
		} 
		function del(dorm_lose_lno) {
			$.ajax({
				url : "/dorm/lose/del.do",
				type : "POST",
				data : {
					"dorm_lose_lno" : dorm_lose_lno
				},
				dataType : "json",
		...
		function handel(dorm_lose_lno) {
			$.ajax({
				url : "/dorm/lose/updateState.do",
				type : "POST",
				data : {
					"dorm_lose_lno" : dorm_lose_lno
				},
