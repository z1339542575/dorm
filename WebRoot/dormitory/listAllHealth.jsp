...
<body class="bg-b">
	...
	<script type="text/javaScript">
		...
		function operateFormatter(value, row, index) {//赋予的参数
     	return [
        '<a class="btn active btn-info btn-sm" onclick="modify(\'' + row.dorm_hea_hno + '\')">更新</a>&nbsp;&nbsp;',
        '<a class="btn active btn-info btn-sm" onclick="del(\'' + row.dorm_hea_hno + '\')">删除</a>&nbsp;&nbsp;',
   		].join('');
   		}
   		function modify(dorm_hea_hno) {
			window.location.href="/dorm/health/modify.do?dorm_hea_hno="+dorm_hea_hno;
		} 
		function del(dorm_hea_hno) {
			$.ajax({
				url : "/dorm/health/del.do",
				type : "POST",
				data : {
					"dorm_hea_hno" : dorm_hea_hno
				},
				dataType : "json",
